...
@implementation DeleteFavouriteBuilder
...
+ (NSString *)_path {
    ...
    NSString *_path = [NSString pathStringByReplacingPlaceholdersInString:DELETE_FAV_PATH withValues:[self _requiredURLParameters] andSuffix:@"Key"];
