...
@implementation PaymentHistoryBuilder
...
+ (NSString *)_path {
    ...
    NSString * _path = [NSString pathStringByReplacingPlaceholdersInString:PAYMENT_HISTORY_PATH withValues:[self _requiredURLParameters] andSuffix:@"Key"];
