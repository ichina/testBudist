//
//  PostReceiptsBuilder.m
//  iSeller
//
//  Created by Чина on 14.02.13.
...
@implementation PostReceiptsBuilder
...
+ (NSArray *)_requiredFields {
    ...
    if(_requiredFields == nil) {
        ...
        _requiredFields = [[NSArray alloc] initWithObjects:@"payment[receipt_data]", @"device",nil];
...
+ (NSString *)_path {
    ...
    NSString * _path = [NSString pathStringByReplacingPlaceholdersInString:POST_RECEIPTS_PATH withValues:[self _requiredURLParameters] andSuffix:@"Key"];
