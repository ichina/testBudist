...
@implementation TokenAuthenticationBuilder
...
+ (NSString *)_path {
    ...
    NSString *_path = [NSString pathStringByReplacingPlaceholdersInString:TOKEN_PATH withValues:[self _requiredURLParameters] andSuffix:@"Key"];;
