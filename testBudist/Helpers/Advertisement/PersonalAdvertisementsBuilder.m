//
//  PersonalAdvertisementsBuilder.m
//  iSeller
//
...
@implementation PersonalAdvertisementsBuilder
...
+ (NSString *)_path {
    ...
    NSString *_path = [NSString pathStringByReplacingPlaceholdersInString:MY_ADS_PATH withValues:[self _requiredURLParameters] andSuffix:@"Key"];
