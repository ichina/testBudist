...
//  iSeller
//
//  Created by Чина on 06.02.13.
//  Copyright (c) 2013 CloudTeam. All rights reserved.
//

#import "PutProfileBuilder.h"
#import "NSString+Extensions.h"
@implementation PutProfileBuilder
...
+ (NSString *)_path {
    ...
    NSString * _path = [NSString pathStringByReplacingPlaceholdersInString:PUT_PROFILE_PATH withValues:[self _requiredURLParameters] andSuffix:@"Key"];
