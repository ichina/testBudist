//
//  EmailConfirmationBuilder.m
//  iSeller
//
//  Created by Paul Semionov on 20.03.13.
...
@implementation EmailConfirmationBuilder
...
+ (NSString *)_path {
    ...
    NSString * _path = [NSString pathStringByReplacingPlaceholdersInString:CONFIRM_EMAIL_PATH withValues:[self _requiredURLParameters] andSuffix:@"Key"];
