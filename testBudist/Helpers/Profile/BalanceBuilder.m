...
//  iSeller
//
//  Created by Paul Semionov on 21.03.13.
...
+ (NSString *)_path {
    ...
    NSString * _path = [NSString pathStringByReplacingPlaceholdersInString:GET_BALANCE_PATH withValues:[self _requiredURLParameters] andSuffix:@"Key"];
